...
class TaineePayment extends StatefulWidget {
  static String id = "TaineePayment";

  @override
  _TaineePaymentState createState() => _TaineePaymentState();
}

class _TaineePaymentState extends State<TaineePayment> {
  @override
